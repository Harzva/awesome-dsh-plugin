...
- [Harzva/dsh-superterminal](https://github.com/Harzva/dsh-superterminal) — 面向 macOS 上 DSH 0.1.1-rc.2 的原生终端，支持终端 AI 会话、通过 DSH AI 或独立 Pi/Codex 任务进行有限轮次群讨论，以及结论交接、验收与返工。
